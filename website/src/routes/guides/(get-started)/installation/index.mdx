...
Valibot includes an agent skill that teaches AI agents the correct patterns for generating Valibot schemas.

```bash
npx skills add open-circle/agent-skills
```

[Learn more](https://github.com/open-circle/agent-skills) about the valibot skill.
